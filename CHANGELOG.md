...
## `soldeer` - [0.12.0](https://github.com/mario-eth/soldeer/compare/v0.11.0...v0.12.0) - 2026-09-07

### Other
- release v0.12.0 ([#408](https://github.com/mario-eth/soldeer/pull/408))
- use cargo manifest v3 and update dependencies ([#399](https://github.com/mario-eth/soldeer/pull/399))

## `soldeer-commands` - [0.12.0](https://github.com/mario-eth/soldeer/compare/soldeer-commands-v0.11.0...soldeer-commands-v0.12.0) - 2026-09-07

### Added
- *(lock)* add lockfile versioning ([#398](https://github.com/mario-eth/soldeer/pull/398))

### Fixed
- errors not showing properly ([#395](https://github.com/mario-eth/soldeer/pull/395))
- *(download)* validate archive entries before extraction ([#377](https://github.com/mario-eth/soldeer/pull/377))
- verify that lockfile entries match their config items ([#394](https://github.com/mario-eth/soldeer/pull/394))
...
### Other
- release v0.12.0 ([#408](https://github.com/mario-eth/soldeer/pull/408))
- fix test ([#404](https://github.com/mario-eth/soldeer/pull/404))
- use cargo manifest v3 and update dependencies ([#399](https://github.com/mario-eth/soldeer/pull/399))

## `soldeer-core` - [0.12.0](https://github.com/mario-eth/soldeer/compare/soldeer-core-v0.11.0...soldeer-core-v0.12.0) - 2026-09-07

### Added
- *(lock)* add lockfile versioning ([#398](https://github.com/mario-eth/soldeer/pull/398))

### Fixed
- *(push)* remove gitlink files from published archive ([#397](https://github.com/mario-eth/soldeer/pull/397))
- *(utils)* harden git commands for older git versions ([#396](https://github.com/mario-eth/soldeer/pull/396))
- *(download)* validate archive entries before extraction ([#377](https://github.com/mario-eth/soldeer/pull/377))
- verify that lockfile entries match their config items ([#394](https://github.com/mario-eth/soldeer/pull/394))
- *(auth)* tighten login file permissions and location ([#375](https://github.com/mario-eth/soldeer/pull/375))
...
## `soldeer` - [0.12.0](https://github.com/mario-eth/soldeer/compare/v0.11.0...v0.12.0) - 2026-09-06

### Other
- use cargo manifest v3 and update dependencies ([#399](https://github.com/mario-eth/soldeer/pull/399))

## `soldeer-commands` - [0.12.0](https://github.com/mario-eth/soldeer/compare/soldeer-commands-v0.11.0...soldeer-commands-v0.12.0) - 2026-09-06
...
## `soldeer-core` - [0.12.0](https://github.com/mario-eth/soldeer/compare/soldeer-core-v0.11.0...soldeer-core-v0.12.0) - 2026-09-06
