...
use crate::config::remappings;
use crate::config::Dependency;
use crate::dependency_downloader::download_dependencies;
use crate::dependency_downloader::unzip_dependencies;
use crate::dependency_downloader::unzip_dependency;
use crate::janitor::healthcheck_dependencies;
use crate::janitor::cleanup_after;

#[tokio::main]
async fn main() {
    let args: Vec<String> = env::args().collect();
    let command: (String, String) = process_args(args).unwrap();
