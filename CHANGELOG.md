...
## `soldeer` - [0.6.2](https://github.com/mario-eth/soldeer/compare/v0.6.1...v0.6.2) - 2025-08-22

### Other
- update Cargo.lock dependencies

## `soldeer-commands` - [0.6.2](https://github.com/mario-eth/soldeer/compare/soldeer-commands-v0.6.1...soldeer-commands-v0.6.2) - 2025-08-22

### Fixed
- *(cmd)* avoid panicking if logger was already initialized ([#312](https://github.com/mario-eth/soldeer/pull/312))

## `soldeer-core` - [0.6.2](https://github.com/mario-eth/soldeer/compare/soldeer-core-v0.6.1...soldeer-core-v0.6.2) - 2025-08-22
