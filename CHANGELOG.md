...
## `soldeer` - [0.5.5](https://github.com/mario-eth/soldeer/compare/v0.5.4...v0.5.5) - 2025-07-02

### Other
- update Cargo.lock dependencies

## `soldeer-commands` - [0.5.5](https://github.com/mario-eth/soldeer/compare/soldeer-commands-v0.5.4...soldeer-commands-v0.5.5) - 2025-07-02

### Fixed
- *(commands)* canonicalize path in push command ([#284](https://github.com/mario-eth/soldeer/pull/284))

## `soldeer-core` - [0.5.5](https://github.com/mario-eth/soldeer/compare/soldeer-core-v0.5.4...soldeer-core-v0.5.5) - 2025-07-02
